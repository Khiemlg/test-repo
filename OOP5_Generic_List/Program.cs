...
// BTVN
//câu 6 U sữa thông tin nhân viên
//-Bổ sung chức năng SỬA thông tin Nhân viên
Console.WriteLine("-----------------------------BTVN-------------------------------");
Console.WriteLine("-----------------------------Update-------------------------------");
manager.UpdateEmployee(3, "Ly gia khiem", "7724", new DateTime(2004, 7, 5));
Console.WriteLine("\nĐây là list sau khi Uppdate :");
manager.ShowAllData();

Console.WriteLine("-----------------------------Delete-------------------------------");
//- Bổ sung chức năng Xóa thông tin nhân viên
manager.DeleteEmployee(4);
Console.WriteLine("\nĐây là list sau khi xóa :");
manager.ShowAllData();
